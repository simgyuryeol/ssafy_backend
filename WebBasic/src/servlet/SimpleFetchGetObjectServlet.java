...
@WebServlet("/SimpleFetchGetObjectServlet")
public class SimpleFetchGetObjectServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("SimpleFetchGetObjectServlet JSON : " + jsonStr);
	}
